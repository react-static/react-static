...
In custom component routing, you also setup your routes in getRoutes of the static.config.js, but you don’t specify the component! ```{path: “foo”}``` Instead, you specify the routes in the components ```<Route path='/foo' component={MyFoo} \>```
