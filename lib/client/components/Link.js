...
(function () {
  ...
  reactHotLoader.register(isRoutingUrl, 'isRoutingUrl', 'src/client/components/Link.js');
  reactHotLoader.register(reactRouterProps, 'reactRouterProps', 'src/client/components/Link.js');
  reactHotLoader.register(SmartLink, 'SmartLink', 'src/client/components/Link.js');
  reactHotLoader.register(Link, 'Link', 'src/client/components/Link.js');
  reactHotLoader.register(NavLink, 'NavLink', 'src/client/components/Link.js');
  leaveModule(module);
})();
