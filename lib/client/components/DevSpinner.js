...
(function () {
  ...
  reactHotLoader.register(DevSpinner, 'DevSpinner', 'src/client/components/DevSpinner.js');
  reactHotLoader.register(_default, 'default', 'src/client/components/DevSpinner.js');
  leaveModule(module);
})();
