...
(function () {
  ...
  reactHotLoader.register(Loading, 'Loading', 'src/client/components/Loading.js');
  reactHotLoader.register(withLoading, 'withLoading', 'src/client/components/Loading.js');
  reactHotLoader.register(_default, 'default', 'src/client/components/Loading.js');
  leaveModule(module);
})();
