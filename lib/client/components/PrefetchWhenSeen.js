...
(function () {
  ...
  reactHotLoader.register(ioIsSupported, 'ioIsSupported', 'src/client/components/PrefetchWhenSeen.js');
  reactHotLoader.register(handleIntersection, 'handleIntersection', 'src/client/components/PrefetchWhenSeen.js');
  reactHotLoader.register(PrefetchWhenSeen, 'PrefetchWhenSeen', 'src/client/components/PrefetchWhenSeen.js');
  reactHotLoader.register(_default, 'default', 'src/client/components/PrefetchWhenSeen.js');
  leaveModule(module);
})();
