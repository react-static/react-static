...
(function () {
  ...
  reactHotLoader.register(siteDataPromise, 'siteDataPromise', 'src/client/components/SiteData.js');
  reactHotLoader.register(SiteData, 'SiteData', 'src/client/components/SiteData.js');
  reactHotLoader.register(withSiteData, 'withSiteData', 'src/client/components/SiteData.js');
  reactHotLoader.register(_default, 'default', 'src/client/components/SiteData.js');
  leaveModule(module);
})();
