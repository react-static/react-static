...
var _default = function _default(_ref) {
  ...
  return {
    ...
    entry: [require.resolve('react-hot-loader/patch'),

    // require.resolve('react-dev-utils/webpackHotDevClient'),
    require.resolve('webpack-dev-server/client') + '?/', require.resolve('webpack/hot/only-dev-server'), _path2.default.resolve(ROOT, config.entry)],
    output: {
