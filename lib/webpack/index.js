          ...
          case 0:
            return _context6.abrupt('return', new Promise(function (resolve, reject) {
              (0, _webpack2.default)([webpackConfig({ config: config, stage: 'prod' }), webpackConfig({ config: config, stage: 'node' })]).run(function (err, stats) {
                ...
                var prodBuildErrors = prodStats.hasErrors();
                var prodBuildWarnings = prodStats.hasWarnings();

                var nodeBuildErrors = nodeStats.hasErrors();
                var nodeBuildWarnings = nodeStats.hasWarnings();
