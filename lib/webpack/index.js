          ...
          case 7:
            ...
            devServerConfig = _extends({
              ...
              setup: function setup(app) {
                ...
                app.get('/__config__/siteProps', function () {
                ...
                app.get('/__config__/getRoutes', function () {
                        ...
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 3:
                            ...
                            routes.forEach(function (route) {
                              app.get('/__config__/route' + route.path, function () {
...
var buildProductionBundles = exports.buildProductionBundles = function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee6(_ref10) {
    ...
    var build, prodCompiler, nodeCompiler;
    return _regenerator2.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            build = function build(stage, compiler) {
