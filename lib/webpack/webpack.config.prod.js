...
var _default = function _default(_ref) {
  ...
  return {
    ...
    }), new _caseSensitivePathsWebpackPlugin2.default(), !isNode && new _webpack2.default.optimize.UglifyJsPlugin(), config.bundleAnalyzer && !isNode && new _webpackBundleAnalyzer.BundleAnalyzerPlugin()].filter(function (d) {
      return d;
    }),
